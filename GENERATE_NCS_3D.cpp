/*
Generate NCs structure with the size and position especified a plain text.
*/
#include "TF1.h"
#include "TH2F.h"
...
void GENERATE_NCS_3D()
{
    new MAIN_FRAME();
}

MAIN_FRAME::MAIN_FRAME()/*  : TGMainFrame(gClient->GetRoot()) */ {
    TString nameInput = "3D-1NC.txt";
    TString nameOutput = "3D_1NC_structure.txt";
